...
enum BLEPeripheralObserverEvent {
  BLEConnected = 0,
  BLEDisconnected = 1,
  BLEBonded = 2,
...
typedef void (*BLEPeripheralObserverEventHandler)(BLECentral& central);
...
class BLEPeripheralObserver : public BLEDeviceEventListener,
                        ...
                        public BLERemoteCharacteristicValueChangeListener
{
  public:
    ...
    void setEventHandler(BLEPeripheralObserverEvent event, BLEPeripheralObserverEventHandler eventHandler);
